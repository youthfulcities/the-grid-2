  ...
  <Flex className={styles.footerContainer}>
    ...
    <Flex className={styles.linkSection}>
      <Flex className={styles.linkColumn}>
        <Link href='/' passHref>
          <Text className={styles.smallText}>Home</Text>
        </Link>
        <Link href='/about' passHref>
          <Text className={styles.smallText}>About</Text>
        </Link>
        <Link href='/datasets' passHref>
          <Text className={styles.smallText}>Datasets</Text>
        </Link>
        <Link href='/data-playground' passHref>
          <Text className={styles.smallText}>Data Playground</Text>
        </Link>
      </Flex>

      <Flex className={styles.linkColumn}>
        <Link href='/faq' passHref>
          <Text className={styles.smallText}>FAQ</Text>
        </Link>
        <Link href='/contact' passHref>
          <Text className={styles.smallText}>Contact Us</Text>
        </Link>
        <Link href='/tutorials' passHref>
          <Text className={styles.smallText}>Tutorials</Text>
        </Link>
      </Flex>
    </Flex>
