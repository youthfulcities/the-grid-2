...
import { Heading, Text, View, useBreakpointValue } from '@aws-amplify/ui-react';
...
const sections = [
  { id: 'mismatch', label: 'Skill Mismatch' },
    ...
    <Container>
      ...
      <View className='container padding'>
        ...
        <div className='inner-container' ref={containerRef}>
          ...
          <Section id='mismatch'>
            <Heading level={2} marginTop='xxl' color='font.inverse'>
              Skill Mismatch
            </Heading>
            <Heading level={3} color='font.inverse'>
            ...
            <Heading
              ...
              marginTop='xl'
            >
              What makes an organization/company the most attractive to work
              for?
            </Heading>
            <BarChart
              width={width}
          ...
          <Section id='future'>
            <Heading level={2} marginTop='xxxl' color='font.inverse'>
              Future of work
            </Heading>
            <Heading level={3} color='font.inverse'>
              Work Styles
