...
export default function Home() {
    return (
        <View style={{
            backgroundColor: '#550d35', height: '100vh',
            ...
            <View style={{ textAlign: 'center' }}>
                ...
                <p style={{ color: 'white', fontSize: '15px', marginTop: '15px' }}>
                    If you have any questions or want to contact us, <a href="https://www.youthfulcities.com/contact-us/#lets-talk" style={{ color: '#fbd166' }}>click here</a>.
                </p>
            </View>
        </View>
    );
